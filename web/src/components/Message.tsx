...
const Message = (props: Props) => {
  ...
  return (
    <motion.div
      drag
    >
      <div className={`bg-${color}-100 border border-${color}-400 text-${color}-700 px-4 py-3 rounded relative`} role="alert" onClick={() => setIsOpen(false)}>
        <strong className="font-bold">{props.status}</strong>
